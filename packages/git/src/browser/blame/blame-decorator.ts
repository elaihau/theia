...
import {
    EditorManager, EditorDecorationsService, TextEditor, EditorDecoration, EditorDecorationOptions, Range, Position, DecorationStyle, DecorationStyles
...
export class BlameDecorator {
    ...
    protected toDecorations(blame: GitFileBlame, highlightLine: number): BlameDecorations {
        ...
        const beforeContentStyles = new Map<string, DecorationStyle>();
        ...
        for (const commit of commits) {
            ...
            beforeContentStyles.set(sha, new DecorationStyle(selector, style => {
                DecorationStyles.copyStyle(BlameDecorator.defaultGutterStyles, style);
...
export namespace BlameDecorator {
    ...
    export const continuationStyle = new DecorationStyle('gitBlameContinuationLine::before', style => {
        style.content = `'\u2007'`; // blank
    });

    export const highlightStyle = new DecorationStyle('gitBlameHighlight::before', style => {
